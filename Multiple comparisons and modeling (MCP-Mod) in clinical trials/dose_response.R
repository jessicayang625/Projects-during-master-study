...
#      ylab = "Percentage of pain-free patients",type="l", col="red")
#dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/dose.pdf")
...
plot(gfit, plotData = "meansCI", CI = TRUE, ylab ="coefficients", 
     main="Emax model")
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/emax_logit.pdf")


## model on probability scale
logitPred <- predict(gfit, predType ="ls-means", doseSeq = 0:200,
                     se.fit=TRUE)
plot (data$dose, data$resp/migraine$ntrt, pch=1, col="blue", 
      ylim = c(0, 0.5), ylab = "Probability of being painfree", 
      xlab = "Dose(mg)", main="Emax model on probability scale")

lines(0:200, 1/(1+exp(-logitPred$fit)), type = "l")
LB <- logitPred$fit-qnorm(0.975)*logitPred$se.fit
UB <- logitPred$fit+qnorm(0.975)*logitPred$se.fit
lines(0:200, 1/(1+exp(-LB)), col="red", lty=2)
lines(0:200, 1/(1+exp(-UB)), col="red", lty=2)
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/emax.pdf")
...
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/quad_logit.pdf")

## model on probability scale
logitPred <- predict(gfit_quad, predType ="ls-means", doseSeq = 0:200,
                     se.fit=TRUE)
plot (data$dose, data$resp/migraine$ntrt, pch=1, col="blue", 
      ylim = c(0, 0.5), ylab = "Probability of being painfree", 
...
lines(0:200, 1/(1+exp(-LB)), col="red", lty=2)
lines(0:200, 1/(1+exp(-UB)), col="red", lty=2)
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/quad.pdf")
...
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/emax_quad.pdf")
...
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/TD_30.pdf")

plot(fmodels, plotTD = TRUE, Delta = 0.2)
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/ED_20.pdf")

plot(fmodels, plotTD = TRUE, Delta = 0.1)
dev.copy2pdf(device = quartz, file = "/Users/Yeonil/Desktop/consulting result/ED_10.pdf")
